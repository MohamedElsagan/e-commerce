...
/** PRODUCT */
app.use("/api/change-lang/:lang/categories", langMiddleWare, accessTokenMiddleware, isAdminMiddleware, gloabalLimiter, categoryRouter);
app.use("/api/change-lang/:lang/products", langMiddleWare, accessTokenMiddleware, isAdminMiddleware, gloabalLimiter, productRouter);
